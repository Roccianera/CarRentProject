...
public class VisualizzaParcoAuto extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8273723586789842828L;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VisualizzaParcoAuto frame = new VisualizzaParcoAuto();
	...
	public VisualizzaParcoAuto() {
		...
		ArrayList<Hashtable<String, String>> tabellaHash;
		
		
		 try {
			tabellaHash =  NoleggiAutoController.VisualizzaParcoAuto();	
			 ...
			 new Messaggio("ERRORE", e.getMessage()).setVisible(true);
